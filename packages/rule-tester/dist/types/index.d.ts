...
export interface RunTests<TMessageIds extends string, TOptions extends Readonly<unknown[]>> {
    readonly valid: readonly (ValidTestCase<TOptions> | string)[];
    readonly invalid: readonly InvalidTestCase<TMessageIds, TOptions>[];
}
export interface NormalizedRunTests<TMessageIds extends string, TOptions extends Readonly<unknown[]>> {
